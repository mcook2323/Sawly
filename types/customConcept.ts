...
export type ConceptImageStatus = "pending" | "ready" | "error";
...
export interface CustomConceptOption {
  ...
  imageStatus: ConceptImageStatus; imageUrl: string | null; verificationStatus: ConceptVerificationStatus;
  verifiedTemplateCandidate: "outdoor-table" | "outdoor-bench" | null;
}
export interface CustomConceptPackage { schemaVersion: 1; id: string; originalPrompt: string; concepts: CustomConceptOption[]; createdAt: string; generationStatus: "complete" | "partial"; }
